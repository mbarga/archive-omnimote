...
//	Init(0x00058000,48000000,2);
///*ProgramPage(	adr:  Page Start Address
//                sz:   Page Size
//                buf:  Page Data  ) */
////can only program 256, 512, 1024 ... ( check ECC implementation; http://www.keil.com/forum/9300/ ) 	
//	ProgramPage(0x00058000, 0x4000, Memory);	  // 0x00058000 is sector 18 head address for LPC2368.
//	UnInit(2);
...
#if USB_RESUME_EVENT
void USB_Resume_Event (void) {                     /* Turn Off Suspend LED */
}
#endif
