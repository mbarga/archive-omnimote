...
extern void delayMs(unsigned char timer_num, unsigned long delayInMs);
extern unsigned long init_timer( unsigned char timer_num, unsigned long timerInterval );
